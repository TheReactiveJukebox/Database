...
CREATE VIEW historyview AS
    SELECT jukebox_user.Name AS UserName, history.RadioId, array_agg(artist.Name) AS Artists, song.Title AS SongTitel, history.Time
    FROM history
    ...
    JOIN jukebox_user ON (jukebox_user.Id = history.UserId)
